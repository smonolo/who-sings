  ...
  return (
    <Modal name="matches">
      <div className={styles.row}>
        <div className={modalStyles.title}>Matches</div>
        <div className={styles.badges}>
          <div
            className={
              styles.badge + ' ' + (filter === 'all' ? styles.activeBadge : '')
            }
          ...
          {username && (
            <div
              className={
                styles.badge +
                ' ' +
                (filter === 'user' ? styles.activeBadge : '')
              }
      ...
      {typeof matches === 'string' && (
        <div className={globalStyles.smallSpacer}>{matches}</div>
      )}
      {matches.length === 0 && (
        <div className={globalStyles.smallSpacer}>No matches to show.</div>
      )}
