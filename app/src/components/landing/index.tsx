...
export default function Landing() {
  ...
  const { username: authUsername } = useAppSelector(
  ...
  return (
    <Layout title="Who Sings" subtitle="A music quiz game by Stefano Monolo.">
      <form ref={formRef} onSubmit={onGameDataSubmit}>
        <div className={globalStyles.spacer}>
          <div className={globalStyles.label}>Username</div>
          <input
            ref={usernameRef}
            type="text"
        ...
        <div className={globalStyles.spacer}>
          <div className={globalStyles.label}>Rounds</div>
          <input
            ref={roundsRef}
            type="number"
            className={globalStyles.input}
        ...
        {state.error && (
          <div className={globalStyles.spacer}>
            <div className={globalStyles.error}>{state.error}</div>
          </div>
        )}
        ...
        <div className={globalStyles.spacer}>
          <div className={styles.deleteData} onClick={deleteAllData}>
            Delete all data
          </div>
        </div>
      </form>
